## Exercise 3: Migrate the application and web tiers using Migration and moderniztion

Duration: 90 minutes

In this exercise you will migrate the web tier and application tiers of the application from on-premises to Azure using Migration and moderniztion.
...
In this task you will create a new Azure Storage Account that will be used by Migration and moderniztion for storage of your virtual machine data during migration.
...
In this task you created a new Azure Storage Account that will be used by Migration and moderniztion.
...
1. On the **Virtual Network** tab, enter the following configuration select **Next:DNS**.
   ...
   - Private IP configuration: **Dynamically allocate IP address**
    ...
    ![Screenshot showing the 'Create a private endpoint' blade, 'Configuration' tab.](images/Exercise3/E3T2S5.png "Create a Private Endpoint - Configuration")
...
### Task 3: Register the Hyper-V Host with Migration and moderniztion

In this task, you will register your Hyper-V host(LabVM) with the Migration and moderniztion service. This service uses Azure Site Recovery as the underlying migration engine. As part of the registration process, you will deploy the Azure Site Recovery Provider on your Hyper-V host.
...
1. Return to the **Azure Migrate | Servers, databases and web apps** blade in the Azure Portal, and select **Servers, databases and web apps (1)** under **Migration goals** on the left. Under **Migration Tools**, select **Discover (2)**.
   ...
   **Note:** You may need to add the migration tool yourself by following the link below the **Migration Tools** section, selecting **Migration and moderniztion**, then selecting **Add tool(s)**.
...
2. In the **Discover** panel, provide the following details:
   ...
   - Check the **confirmation** checkbox and select **Create resources** to begin the deployment of the Azure Site Recovery resource used by Migration and moderniztion for Hyper-V migrations.
...
9. Return to the Azure Migrate browser window. **Refresh** your browser, then re-open the **Discover machines** panel by selecting **Discover** under **Migration and moderniztion** and selecting **Yes, with Hyper-V** for **Are your machines virtualized?**.
...
13. The **Migration and moderniztion** panel should now show 5 discovered servers..

    ![Screenshot of the 'Azure Migrate - Servers' blade showing 6 discovered servers under 'Azure Migrate: Server Migration'.](../Hands-on%20lab/images/discoveredservers.png "Discovered servers")
...
5. On the **Target settings** tab, select the below information,
   ...
   ![Screenshot of the 'Target settings' tab of the 'Replicate' wizard in Azure Migrate Server Migration. The resource group, storage account and virtual network created earlier in this exercise are selected.](../Hands-on%20lab/images/target%20settings.png "Replicate - Target settings")
...
8. In the **Azure Migrate - Servers, databases and web apps** blade, under **Migration and moderniztion**, select the **Overview** button.

    ![Screenshot of the 'Azure Migrate - Servers' blade with the 'Overview' button in the 'Azure Migrate: Server Migration' panel highlighted.](../Hands-on%20lab/images/overviewtools.png "Overview link")
...
1. Still using the **Migration and moderniztion - Replicating machines** blade, select the **smarthotelweb1** virtual machine. This opens a detailed migration and replication blade for this machine. Take a moment to study this information.
...
1. Return to the **Migration and moderniztion** overview blade. Under **Step 3: Migrate**, select **Migrate**.
...
In this exercise you migrated the web tier and application tiers of the application from on-premises to Azure using Migration and moderniztion. Having migrated the virtual machines, you reconfigured the application tier to use the migrated application database hosted in Azure SQL Database, and verified that the migrated application is working end-to-end. You also installed the VM Agent on the migrated virtual machines, and cleaned up migration resources.
