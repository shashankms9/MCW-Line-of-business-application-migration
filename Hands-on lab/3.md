...
2. In the **Create storage account** blade, on the **Basics** tab, use the following values:
   ...
   - Redundancy: **Locally-redundant storage (LRS)**
    ...
    ![Screenshot of the Azure portal showing the create storage account blade.](https://github.com/CloudLabs-MCW/MCW-Line-of-business-application-migration/raw/prod-oldversion/Hands-on%20lab/images/Exercise3/EX3-sg-01.png "Storage account settings")
...
5. Select **Data protection** under **Data management** from the left-hand side menu of storage account.
   ...
   ![Screenshot of the Azure portal showing the create storage account blade.](https://github.com/CloudLabs-MCW/MCW-Line-of-business-application-migration/blob/prod-oldversion/Hands-on%20lab/images/Exercise3/storageaccount-01.png?raw=true "Storage account settings")
...
6. Now, uncheck the box next to **Enable soft delete for blobs** and **Enable soft delete for containers** to disable the soft delete on blobs and container as the soft delete enabled storage account is **not supported** for enabling replication on Virtual Machines. Click on **Save**.
   ...
   ![Screenshot of the Azure portal showing the create storage account blade.](https://github.com/CloudLabs-MCW/MCW-Line-of-business-application-migration/blob/prod-oldversion/Hands-on%20lab/images/Exercise3/storageaccount-02.png?raw=true "Storage account settings")
...
1. On the **Resource** tab, enter the following configuration then select **Next: Virtual Network**:
...
10. Select **Finalize registration**, which should now be enabled.
    ...
    ![Screenshot of the Discover machines' panel from Azure Migrate, highlighting the download link Hyper-V registration key file.](https://github.com/CloudLabs-MCW/MCW-Line-of-business-application-migration/blob/prod-oldversion/Hands-on%20lab/images/Exercise1/e3%20t2%20s10.png?raw=true "Finalize registration")
...
13. The **Azure Migrate: Server Migration** panel should now show 5 discovered servers..
    ...
    ![Screenshot of the 'Azure Migrate - Servers' blade showing 6 discovered servers under 'Azure Migrate: Server Migration'.](https://github.com/CloudLabs-MCW/MCW-Line-of-business-application-migration/raw/prod-oldversion/Hands-on%20lab/images/Exercise3/azuremigrate-13.png "Discovered servers")
...
5. On the **Target settings** tab, select the below information,
   ...
   ![Screenshot of the 'Target settings' tab of the 'Replicate' wizard in Azure Migrate Server Migration. The resource group, storage account and virtual network created earlier in this exercise are selected.](https://github.com/CloudLabs-MCW/MCW-Line-of-business-application-migration/blob/prod-oldversion/Hands-on%20lab/images/Exercise3/migration.png?raw=true "Replicate - Target settings")
...
8. In the **Azure Migrate - Servers, databases and web apps** blade, under **Azure Migrate: Server Migration**, select the **Overview** button.
    ...
    ![Screenshot of the 'Azure Migrate - Servers' blade with the 'Overview' button in the 'Azure Migrate: Server Migration' panel highlighted.](https://github.com/CloudLabs-MCW/MCW-Line-of-business-application-migration/raw/prod-oldversion/Hands-on%20lab/images/Exercise3/azuremigrate-14.png "Overview link")
...
2. On the **Migrate** blade, select **yes** for **Shutdown machines before migration to minimum data loss** and select the 3 virtual machines then select **Migrate** to start the migration process.
   ...
   ![Screenshot of the 'Migrate' blade, with 3 machines selected and the 'Migrate' button highlighted.](https://github.com/CloudLabs-MCW/MCW-Line-of-business-application-migration/blob/prod-oldversion/Hands-on%20lab/images/Exercise1/e3%20t6%20ss2.png?raw=true "Migrate - VM selection")
...
1. Under Security, select Firewalls and virtual networks. Set `Deny public network access` to **Unchecked** and Save your changes.

   ![](images/Exercise3/website1.png)
     
1. Now, click on **Add existing virtual network** to add a virtual network so that the access to the database will be allowed from specific network.

   ![](images/Exercise3/website2.png)
...
1. Navigate back to **Firewalls and virtual networks** blade and Set `Deny public network access` to **checked** and Save your changes.

   ![](images/Exercise3/website4.png)
...
1. Open a new browser tab and paste the IP address into the address bar. Verify that the SmartHotel360 application is now available in Azure.
    ...
    ![Screenshot showing the SmartHotel application.](https://raw.githubusercontent.com/CloudLabs-MCW/MCW-Line-of-business-application-migration/prod-oldversion/Hands-on%20lab/images/Exercise3/lob-issue-02.png "Migrated SmartHotel application")
