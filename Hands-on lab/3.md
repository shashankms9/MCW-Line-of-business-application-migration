...
2. In the **Create storage account** blade, on the **Basics** tab, use the following values:
   ...
   - Redundancy: **Locally-redundant storage (LRS)**
    ...
    ![Screenshot of the Azure portal showing the create storage account blade.](https://github.com/CloudLabs-MCW/MCW-Line-of-business-application-migration/raw/snapshot/Hands-on%20lab/images/Exercise3/EX3-sg-01.png "Storage account settings")
...
5. Select **Data protection** under **Data management** from the left-hand side menu of storage account.
   ...
   ![Screenshot of the Azure portal showing the create storage account blade.](https://github.com/CloudLabs-MCW/MCW-Line-of-business-application-migration/blob/snapshot/Hands-on%20lab/images/Exercise3/storageaccount-01.png?raw=true "Storage account settings")
...
6. Now, uncheck the box next to **Enable soft delete for blobs** and **Enable soft delete for containers** to disable the soft delete on blobs and container as the soft delete enabled storage account is **not supported** for enabling replication on Virtual Machines. Click on **Save**.
   ...
   ![Screenshot of the Azure portal showing the create storage account blade.](https://github.com/CloudLabs-MCW/MCW-Line-of-business-application-migration/blob/snapshot/Hands-on%20lab/images/Exercise3/storageaccount-02.png?raw=true "Storage account settings")
...
1. On the **Resource** tab, enter the following configuration then select **Next: Configuration**:
...
1. On the **Configuration** tab, enter the following configuration select **Tags** and click on **Review + Create** then **Create**:
   ...
   - Private DNS zone: (default) **privatelink.database.windows.net**
    ...
    ![Screenshot showing the 'Create a private endpoint' blade, 'Configuration' tab.](images/Exercise3/privatednsrg2.png "Create a Private Endpoint - Configuration")

1. **Wait** for the deployment to complete. Navigate to the **SmartHotelHostRG** resource group, and then to the endpoint **SmartHotel-DB-Endpoint**.
...
13. The **Azure Migrate: Server Migration** panel should now show 5 discovered servers..
    ...
    ![Screenshot of the 'Azure Migrate - Servers' blade showing 6 discovered servers under 'Azure Migrate: Server Migration'.](https://github.com/CloudLabs-MCW/MCW-Line-of-business-application-migration/raw/snapshot/Hands-on%20lab/images/Exercise3/azuremigrate-13.png "Discovered servers")
...
8. In the **Azure Migrate - Servers, databases and web apps** blade, under **Azure Migrate: Server Migration**, select the **Overview** button.
    ...
    ![Screenshot of the 'Azure Migrate - Servers' blade with the 'Overview' button in the 'Azure Migrate: Server Migration' panel highlighted.](https://github.com/CloudLabs-MCW/MCW-Line-of-business-application-migration/raw/snapshot/Hands-on%20lab/images/Exercise3/azuremigrate-14.png "Overview link")
...
1. Open a new browser tab and paste the IP address into the address bar. Verify that the SmartHotel360 application is now available in Azure.
    ...
    ![Screenshot showing the SmartHotel application.](https://raw.githubusercontent.com/CloudLabs-MCW/MCW-Line-of-business-application-migration/snapshot/Hands-on%20lab/images/Exercise3/lob-issue-02.png "Migrated SmartHotel application")
