...
3. On the **Basics** tab that appears, enter the following configuration then select **Next: Resource**. 
   ...
   ![Screenshot showing the 'Create a private endpoint' blade, 'Basics' tab.](images/Exercise2/endpoint1.png "Private Endpoint - Basics")
...
5. On the **Virtual Network** tab enter the following configuration, click on **Next: DNS**..
   ...
   ![Screenshot showing the 'Create a private endpoint' blade, 'Resource' tab.](images/Exercise2/endpoint3.png "Private Endpoint - Resource")
