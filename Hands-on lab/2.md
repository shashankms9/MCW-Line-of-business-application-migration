...
3. In **Select Database Migration Service** blade, select **Continue to use Azure Database Migration Service to migrate SQL Server, MySQL, PostgreSQL or MongoDB database(s) to Azure SQL MI, Azure SQL DB, Azure DB for MySQL, Azure DB for PostgreSQL and Azure Cosmos DB** and then click on **Select** at the bottom.

   ![Screenshot showing the DMS 'select' button.](images/Exercise2/az-data-mirg-serv-1.png "Select Azure Database Migration Service")
...
4. In the **Create Migration Service** blade, on the **Basics** tab, enter the following values:
   ...
   ![Screenshot showing the Create DMS 'Basics' tab.](https://github.com/CloudLabs-MCW/MCW-Line-of-business-application-migration/blob/prod-oldversion/Hands-on%20lab/images/Exercise2/dms-01.png?raw=true "Create DMS - Basics")
...
1. Return to the **Azure Migrate** blade in the Azure portal. Select the **Get Started** panel, then select **Assess and migrate databases**.
   ...
   ![Screenshot showing the Azure Migrate Overview blade in the Azure portal, with the 'Assess and migrate databases' button highlighted.](https://github.com/CloudLabs-MCW/MCW-Line-of-business-application-migration/raw/prod-oldversion/Hands-on%20lab/images/Exercise2/azuremigrate-11.png "Assess and migrate databases button")  
...
14. Select **Start Assessment** to start the assessment. 
    ...
    ![Screenshot of the DMA showing assessment in progress.](https://github.com/CloudLabs-MCW/MCW-Line-of-business-application-migration/raw/prod-oldversion/Hands-on%20lab/images/Exercise2/Assessment.png "Start assessment")
...
18. Return to the **Azure Migrate - Databases (only)** blade in the Azure portal. Refreshing the page should now show the assessed database.
    ...
    ![Screenshot of the 'Azure Migrate - Databases' blade in the Azure portal, showing 1 assessed database.](https://github.com/CloudLabs-MCW/MCW-Line-of-business-application-migration/raw/prod-oldversion/Hands-on%20lab/images/Exercise2/azuremigrate-12.1.png "Azure Migrate - Database Assessment")
...
9.  In the Azure portal, expand the portal's left navigation by selecting **Show portal menu** in the top left.
   ...
   ![Azure portal screenshot showing the select path to create a SQL Database.](https://github.com/CloudLabs-MCW/MCW-Line-of-business-application-migration/blob/prod-oldversion/Hands-on%20lab/images/Exercise1/e2%20t6%20ss9.png?raw=true "New SQL Database")
