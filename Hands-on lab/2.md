...
3. In **Select Database Migration Service** blade, select **Migrate my SQL Server, MySQL, PostgreSQL or MongoDB database(s) to Azure** and then click on **Select** at the bottom.

   ![Screenshot showing the DMS 'select' button.](images/Exercise2/az-data-mirg-serv.png "Select Azure Database Migration Service")
