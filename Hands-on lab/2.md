...
2. From the left hand side menu, select **Networking** then **Private access** tab. Now, under **Private endpoint connections** click on **+ Private endpoint**.
...
9. On the **privatelink.database.windows.net** overview blade, note that the **Record set** with name **smarthoteldb<inject key="DeploymentID" enableCopy="false" />** and an internal IP address **10.1.0.X** is listed.
