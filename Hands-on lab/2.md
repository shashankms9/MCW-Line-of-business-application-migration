...
4. On the **Resource** tab, make sure the following configurations are selected and click on **Next: Virtual Network**. 
   ...
   ![Screenshot showing the 'Create a private endpoint' blade, 'Resource' tab.](images/Exercise2/Ex-2-lob-01.png "Private Endpoint - Resource")
   
5. On the **Virtual Network** tab enter the following configuration, click on **Next: Tags** then select **Review + create**.
   ...
   ![Screenshot showing the 'Create a private endpoint' blade, 'Configuration' tab.](images/Exercise2/privatednsrg1.png "Private Endpoint - Configuration")
...
10. Return to the Database server blade. Under **Security**, select **Firewalls and virtual networks**. Set `Deny public network access` to **Checked**, then **Save** your changes.

    ![Screenshot showing the link to add an existing virtual network to the SQL database network security settings.](images/Exercise2/deny-firewalls-sqlserver.png "Database Server - Firewalls and virtual networks")
...
11. Navigate to the Database Migration Service **SmartHotelDBMigration** resource blade in the **AzureMigrateRG** resource group and select **+ New Migration Project**.
...
12. In the **New migration project** blade, enter the below information,
...
9.  In the Azure portal, expand the portal's left navigation by selecting **Show portal menu** in the top left.
    ...
    - Under **Security**, select **Private endpoint connections**.
      ...
      ![Azure portal screenshot showing the select path to create a SQL Database.](images/Exercise2/e2%20t6%20ss9.png?raw=true "New SQL Database")
