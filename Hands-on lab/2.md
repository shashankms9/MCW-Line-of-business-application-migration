...
4. In the **Create Migration Service** blade, on the **Basics** tab, enter the following values:
   ...
   ![Screenshot showing the Create DMS 'Basics' tab.](images/Exercise2/dms-01.png "Create DMS - Basics")
...
9.  In the Azure portal, expand the portal's left navigation by selecting **Show portal menu** in the top left.
   ...
   ![Azure portal screenshot showing the select path to create a SQL Database.](images/Exercise1/e2%20t6%20ss9.png?raw=true "New SQL Database")
