...
3.  In **1: Generate Azure Migrate project key**, provide below name for the **Azure Migrate appliance** that you will set up for discovery of Hyper-V VMs. Select **Generate key** to start the creation of the required Azure resources. 
    >**Note**: If the Azure Migrate project key generation failed with error Vault name 'SmartHotekMigrxxxx' is already in use. In this case go to the Azure Migrate main page and create a **new project** with name starting with **SmartHotel**, select that newly created project and generate the key again.   
...
>**Note**: If you see that the discovery process is stuck at **Discovery is in progress** state for more then 5 mintues, then please follow these steps [here](https://github.com/Kalyani7744/Know-Before-You-Go/blob/main/AIW-KBYG/AIW-Infrastructure-Migration.md#2-exercise1---task3---step17).
