...
2. Under **Are your machines virtualized?**, select **Yes, with Hyper-V** from the **drop-down** menu.
    ...
    ![](https://github.com/Shivashant25/MCW-Line-of-business-application-migration/blob/prod-oldversion/Hands-on%20lab/images/Exercise1/SP-Ex1t2s2.png?raw=true)
...
5. Click on **Create assessment** to create the assessment. 
   ...
   ![](https://github.com/Shivashant25/MCW-Line-of-business-application-migration/blob/prod-oldversion/Hands-on%20lab/images/Exercise1/e1%20t4%20ss5.png?raw=true)
